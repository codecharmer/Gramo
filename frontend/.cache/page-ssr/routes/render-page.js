...
var find_path = __webpack_require__(9741);
;// ./.cache/loader.js
/**
...
var gatsby_react_router_scroll = __webpack_require__(9303);
...
var index_modern = __webpack_require__(8192);
// EXTERNAL MODULE: ../node_modules/gatsby-page-utils/dist/apply-trailing-slash-option.js
var apply_trailing_slash_option = __webpack_require__(279);
...
var hasher = __webpack_require__(3280);
...
var context = __webpack_require__(2092);
// EXTERNAL MODULE: ./.cache/slice/server-slice-renderer.js
var server_slice_renderer = __webpack_require__(867);
...
var nth_check_1 = __importDefault(__webpack_require__(2280));
var boolbase_1 = __webpack_require__(5740);
...
var html_1 = __webpack_require__(9233);
...
var entities_json_1 = __importDefault(__webpack_require__(944));
var legacy_json_1 = __importDefault(__webpack_require__(4692));
var xml_json_1 = __importDefault(__webpack_require__(7520));
var decode_codepoint_1 = __importDefault(__webpack_require__(3122));
...
var typeGuess_1 = __webpack_require__(5210);
/**
...
"use strict";
exports.__esModule=true;exports["default"]=void 0;var _gatsby=__webpack_require__(230);/**
...
"use strict";
var React=_interopRequireWildcard(__webpack_require__(7905));var _gatsby=__webpack_require__(230);var _path=__webpack_require__(2003);function _getRequireWildcardCache(nodeInterop){if(typeof WeakMap!=="function")return null;var cacheBabelInterop=new WeakMap();var cacheNodeInterop=new WeakMap();return(_getRequireWildcardCache=function _getRequireWildcardCache(nodeInterop){return nodeInterop?cacheNodeInterop:cacheBabelInterop;})(nodeInterop);}function _interopRequireWildcard(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule){return obj;}if(obj===null||typeof obj!=="object"&&typeof obj!=="function"){return{default:obj};}var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj)){return cache.get(obj);}var newObj={};var hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj){if(key!=="default"&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;if(desc&&(desc.get||desc.set)){Object.defineProperty(newObj,key,desc);}else{newObj[key]=obj[key];}}}newObj.default=obj;if(cache){cache.set(obj,newObj);}return newObj;}// TODO: Remove for v3 - Fix janky path/asset prefixing
...
var parse_js_1 = __webpack_require__(2619);
Object.defineProperty(exports, "parse", ({ enumerable: true, get: function () { return parse_js_1.parse; } }));
var compile_js_1 = __webpack_require__(9929);
...
var node_1 = __webpack_require__(8255);
...
var stringify_1 = __webpack_require__(2819);
var legacy_1 = __webpack_require__(5079);
/**
...
var domhandler_1 = __webpack_require__(2335);
var dom_serializer_1 = __importDefault(__webpack_require__(5552));
var domelementtype_1 = __webpack_require__(129);
/**
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var decode_json_1 = __importDefault(__webpack_require__(7209));
...
var constants = __webpack_require__(7632);
// EXTERNAL MODULE: external "/Users/codecharmer/gramo/node_modules/react/index.js"
var index_js_ = __webpack_require__(7905);
var index_js_default = /*#__PURE__*/__webpack_require__.n(index_js_);
...
var api_runner_ssr = __webpack_require__(5716);
;// ./.cache/head/head-export-handler-for-ssr.js
const React=__webpack_require__(7905);const{grabMatchParams}=__webpack_require__(9741);const{StaticQueryContext}=__webpack_require__(230);const{headExportValidator,filterHeadProps,isElementType,isValidNodeName,warnForInvalidTag}=__webpack_require__(4644);const{ServerLocation,Router}=__webpack_require__(8192);const{renderToString}=__webpack_require__(9701);const{parse}=__webpack_require__(7388);const styleToOjbect=__webpack_require__(4120);function applyHtmlAndBodyAttributesSSR(htmlAndBodyAttributes,{setHtmlAttributes,setBodyAttributes}){if(!htmlAndBodyAttributes)return;const{html,body}=htmlAndBodyAttributes;setHtmlAttributes(html);setBodyAttributes(body);}function getValidHeadNodesAndAttributesSSR(rootNode,htmlAndBodyAttributes={html:{},body:{}}){const seenIds=new Map();const validHeadNodes=[];// Filter out non-element nodes before looping since we don't care about them
...
var objectSorter_1 = __importDefault(__webpack_require__(5239));
 ...
 */
var boolbase_1 = __webpack_require__(5740);
var css_what_1 = __webpack_require__(902);
var filters_1 = __webpack_require__(1164);
Object.defineProperty(exports, "filters", ({ enumerable: true, get: function () { return filters_1.filters; } }));
var pseudos_1 = __webpack_require__(5576);
Object.defineProperty(exports, "pseudos", ({ enumerable: true, get: function () { return pseudos_1.pseudos; } }));
var aliases_1 = __webpack_require__(9643);
Object.defineProperty(exports, "aliases", ({ enumerable: true, get: function () { return aliases_1.aliases; } }));
var subselects_1 = __webpack_require__(9572);
...
"use strict";
module.exports = require("/Users/codecharmer/gramo/frontend/.cache/ssr-builtin-trackers/fs");
...
var DomUtils = __importStar(__webpack_require__(3982));
var boolbase_1 = __webpack_require__(5740);
var compile_1 = __webpack_require__(8492);
var subselects_1 = __webpack_require__(9572);
...
var pseudo_selectors_1 = __webpack_require__(3463);
...
__exportStar(__webpack_require__(2819), exports);
__exportStar(__webpack_require__(8820), exports);
__exportStar(__webpack_require__(7405), exports);
__exportStar(__webpack_require__(3048), exports);
__exportStar(__webpack_require__(5079), exports);
__exportStar(__webpack_require__(8671), exports);
__exportStar(__webpack_require__(2487), exports);
...
var parse = __webpack_require__(848);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var css_what_1 = __webpack_require__(902);
var procedure_1 = __webpack_require__(1172);
var attributes = {
    exists: 10,
    equals: 8,
    not: 7,
...
/* harmony export */ });
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7632);
/**
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var node_1 = __importDefault(__webpack_require__(7016));
var type_1 = __importDefault(__webpack_require__(3152));
...
var domhandler_1 = __webpack_require__(2335);
var querying_1 = __webpack_require__(3048);
var Checks = {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var he_1 = __webpack_require__(2639);
var node_1 = __importDefault(__webpack_require__(7016));
var type_1 = __importDefault(__webpack_require__(3152));
/**
...
"use strict";
module.exports = require("/Users/codecharmer/gramo/frontend/.cache/ssr-builtin-trackers/https");
...
var typeGuess_1 = __webpack_require__(5210);
var str = __importStar(__webpack_require__(1836));
/**
...
"use strict";
var _interopRequireDefault=__webpack_require__(6784);var React=_interopRequireWildcard(__webpack_require__(7905));var _gatsby=__webpack_require__(230);var _common=__webpack_require__(5326);var _getManifestPathname=_interopRequireDefault(__webpack_require__(1846));function _getRequireWildcardCache(nodeInterop){if(typeof WeakMap!=="function")return null;var cacheBabelInterop=new WeakMap();var cacheNodeInterop=new WeakMap();return(_getRequireWildcardCache=function(nodeInterop){return nodeInterop?cacheNodeInterop:cacheBabelInterop;})(nodeInterop);}function _interopRequireWildcard(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule){return obj;}if(obj===null||typeof obj!=="object"&&typeof obj!=="function"){return{default:obj};}var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj)){return cache.get(obj);}var newObj={};var hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj){if(key!=="default"&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;if(desc&&(desc.get||desc.set)){Object.defineProperty(newObj,key,desc);}else{newObj[key]=obj[key];}}}newObj.default=obj;if(cache){cache.set(obj,newObj);}return newObj;}// TODO: remove for v3
...
"use strict";
var _interopRequireDefault=__webpack_require__(6784);var _path=_interopRequireDefault(__webpack_require__(2003));exports.favicons=[{src:`favicon-32x32.png`,sizes:`32x32`,type:`image/png`}];// default icons for generating icons
...
var entities_1 = __webpack_require__(5560);
/**
 ...
 */
var foreignNames_1 = __webpack_require__(826);
...
var encode_1 = __webpack_require__(1924);
/**
...
var encode_2 = __webpack_require__(1924);
...
exports.components={"component---src-pages-404-tsx":()=>__webpack_require__.e(/* import() | component---src-pages-404-tsx */ 453).then(__webpack_require__.bind(__webpack_require__, 5800)),"component---src-templates-cart-tsx":()=>__webpack_require__.e(/* import() | component---src-templates-cart-tsx */ 494).then(__webpack_require__.bind(__webpack_require__, 4665)),"component---src-templates-checkout-tsx":()=>Promise.all(/* import() | component---src-templates-checkout-tsx */[__webpack_require__.e(736), __webpack_require__.e(772)]).then(__webpack_require__.bind(__webpack_require__, 2022)),"component---src-templates-coffee-index-tsx":()=>Promise.all(/* import() | component---src-templates-coffee-index-tsx */[__webpack_require__.e(736), __webpack_require__.e(595), __webpack_require__.e(749), __webpack_require__.e(90), __webpack_require__.e(927)]).then(__webpack_require__.bind(__webpack_require__, 9667)),"component---src-templates-coffee-tsx":()=>Promise.all(/* import() | component---src-templates-coffee-tsx */[__webpack_require__.e(595), __webpack_require__.e(749), __webpack_require__.e(708)]).then(__webpack_require__.bind(__webpack_require__, 6553)),"component---src-templates-journal-category-tsx":()=>__webpack_require__.e(/* import() | component---src-templates-journal-category-tsx */ 446).then(__webpack_require__.bind(__webpack_require__, 8662)),"component---src-templates-journal-post-tsx":()=>Promise.all(/* import() | component---src-templates-journal-post-tsx */[__webpack_require__.e(736), __webpack_require__.e(595), __webpack_require__.e(749), __webpack_require__.e(90), __webpack_require__.e(88)]).then(__webpack_require__.bind(__webpack_require__, 5696)),"component---src-templates-location-tsx":()=>__webpack_require__.e(/* import() | component---src-templates-location-tsx */ 289).then(__webpack_require__.bind(__webpack_require__, 4618)),"component---src-templates-locations-index-tsx":()=>Promise.all(/* import() | component---src-templates-locations-index-tsx */[__webpack_require__.e(736), __webpack_require__.e(595), __webpack_require__.e(749), __webpack_require__.e(90), __webpack_require__.e(663)]).then(__webpack_require__.bind(__webpack_require__, 8365)),"component---src-templates-menu-tsx":()=>Promise.all(/* import() | component---src-templates-menu-tsx */[__webpack_require__.e(736), __webpack_require__.e(595), __webpack_require__.e(749), __webpack_require__.e(90), __webpack_require__.e(741)]).then(__webpack_require__.bind(__webpack_require__, 5127)),"component---src-templates-order-confirmed-tsx":()=>Promise.all(/* import() | component---src-templates-order-confirmed-tsx */[__webpack_require__.e(736), __webpack_require__.e(772), __webpack_require__.e(508)]).then(__webpack_require__.bind(__webpack_require__, 1471)),"component---src-templates-page-tsx":()=>Promise.all(/* import() | component---src-templates-page-tsx */[__webpack_require__.e(736), __webpack_require__.e(595), __webpack_require__.e(749), __webpack_require__.e(90), __webpack_require__.e(265)]).then(__webpack_require__.bind(__webpack_require__, 8853))};
...
"use strict";
module.exports = require("/Users/codecharmer/gramo/frontend/.cache/ssr-builtin-trackers/http");
...
/* harmony export */ });
var plugins=[{name:'gatsby-plugin-image',plugin:__webpack_require__(6438),options:{"plugins":[]}},{name:'gatsby-plugin-manifest',plugin:__webpack_require__(5290),options:{"plugins":[],"name":"Gramo Café","short_name":"Gramo","start_url":"/","background_color":"#F2EBDD","theme_color":"#191410","display":"minimal-ui","icon":"src/images/icon.png","legacy":true,"theme_color_in_head":true,"cache_busting_mode":"query","crossOrigin":"anonymous","include_favicon":true,"cacheDigest":"c178463a215805398faa51a728598be9"}},{name:'gatsby-plugin-sitemap',plugin:__webpack_require__(1960),options:{"plugins":[],"excludes":["/en/404/","/404/","/pedido/**","/en/order/**"],"output":"/","createLinkInHead":true,"entryLimit":45000,"query":"{ site { siteMetadata { siteUrl } } allSitePage { nodes { path } } }"}},{name:'default-site-plugin',plugin:__webpack_require__(6586),options:{"plugins":[]}},{name:'partytown',plugin:__webpack_require__(7591),options:{"plugins":[]}}];/* global plugins */// During bootstrap, we write requires at top of this file which looks like:
// var plugins = [
//   {
...
//   },
// ]
const apis=__webpack_require__(9095);function augmentErrorWithPlugin(plugin,err){if(plugin.name!==`default-site-plugin`){// default-site-plugin is user code and will print proper stack trace,
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7905);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2688);
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7905);
/* harmony import */ var _gatsbyjs_reach_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8192);
"use client"
...
var attributes_1 = __webpack_require__(5488);
var pseudo_selectors_1 = __webpack_require__(3463);
var css_what_1 = __webpack_require__(902);
/*
 * All available rules
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7905);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _src_state_cart__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6932);
/**
 ...
 */const onRenderBody=({setHtmlAttributes,pathname})=>{const isEnglish=typeof pathname==='string'&&(pathname==='/en'||pathname.startsWith('/en/'));setHtmlAttributes({lang:isEnglish?'en':'es-MX'});};const wrapRootElement=({element})=>/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_src_state_cart__WEBPACK_IMPORTED_MODULE_1__/* .CartProvider */ .e,null,element);
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   _: () => (/* binding */ useCart),
/* harmony export */   e: () => (/* binding */ CartProvider)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7905);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/**
 ...
 */const STORAGE_KEY='gramo-cart-v1';const MAX_QTY=24;const CartContext=/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createContext(null);function CartProvider({children}){const[lines,setLines]=react__WEBPACK_IMPORTED_MODULE_0__.useState([]);const[hydrated,setHydrated]=react__WEBPACK_IMPORTED_MODULE_0__.useState(false);react__WEBPACK_IMPORTED_MODULE_0__.useEffect(()=>{try{const raw=window.localStorage.getItem(STORAGE_KEY);if(raw){const parsed=JSON.parse(raw);if(Array.isArray(parsed)){setLines(parsed.filter(l=>l&&l.productId>0&&l.qty>0));}}}catch{// Ignore corrupted storage.
}setHydrated(true);},[]);react__WEBPACK_IMPORTED_MODULE_0__.useEffect(()=>{if(!hydrated)return;try{window.localStorage.setItem(STORAGE_KEY,JSON.stringify(lines));}catch{// Storage may be unavailable (private mode); the cart still works in memory.
}},[lines,hydrated]);const add=react__WEBPACK_IMPORTED_MODULE_0__.useCallback((line,qty=1)=>{setLines(prev=>{const existing=prev.find(l=>l.productId===line.productId);if(existing){return prev.map(l=>l.productId===line.productId?{...l,qty:Math.min(MAX_QTY,l.qty+qty)}:l);}return[...prev,{...line,qty:Math.min(MAX_QTY,qty)}];});},[]);const setQty=react__WEBPACK_IMPORTED_MODULE_0__.useCallback((productId,qty)=>{setLines(prev=>qty<=0?prev.filter(l=>l.productId!==productId):prev.map(l=>l.productId===productId?{...l,qty:Math.min(MAX_QTY,qty)}:l));},[]);const remove=react__WEBPACK_IMPORTED_MODULE_0__.useCallback(productId=>{setLines(prev=>prev.filter(l=>l.productId!==productId));},[]);const clear=react__WEBPACK_IMPORTED_MODULE_0__.useCallback(()=>setLines([]),[]);const count=lines.reduce((sum,l)=>sum+l.qty,0);const subtotal=lines.reduce((sum,l)=>sum+l.qty*l.price,0);const value=react__WEBPACK_IMPORTED_MODULE_0__.useMemo(()=>({lines,hydrated,add,setQty,remove,clear,count,subtotal}),[lines,hydrated,add,setQty,remove,clear,count,subtotal]);return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(CartContext.Provider,{value:value},children);}function useCart(){const context=react__WEBPACK_IMPORTED_MODULE_0__.useContext(CartContext);if(!context){throw new Error('useCart must be used inside CartProvider');}return context;}
...
var comment_1 = __importDefault(__webpack_require__(5059));
exports.CommentNode = comment_1.default;
var html_1 = __importDefault(__webpack_require__(9233));
exports.HTMLElement = html_1.default;
var node_1 = __importDefault(__webpack_require__(7016));
exports.Node = node_1.default;
var text_1 = __importDefault(__webpack_require__(5155));
exports.TextNode = text_1.default;
var type_1 = __importDefault(__webpack_require__(3152));
exports.NodeType = type_1.default;
var parse_1 = __importDefault(__webpack_require__(1199));
var valid_1 = __importDefault(__webpack_require__(3094));
...
var _react = _interopRequireDefault(__webpack_require__(7905));
...
"use strict";
module.exports = require("/Users/codecharmer/gramo/node_modules/react/index.js");
...
/* harmony import */ var invariant__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7315);
...
var css_what_1 = __webpack_require__(902);
var boolbase_1 = __webpack_require__(5740);
var sort_1 = __importDefault(__webpack_require__(4545));
var procedure_1 = __webpack_require__(1172);
var general_1 = __webpack_require__(6393);
var subselects_1 = __webpack_require__(9572);
/**
...
var _scrollHandler = __webpack_require__(9531);
var _react = __webpack_require__(7905);
var _reachRouter = __webpack_require__(8192);
...
var css_select_1 = __webpack_require__(3949);
var he_1 = __importDefault(__webpack_require__(2639));
var back_1 = __importDefault(__webpack_require__(1057));
var matcher_1 = __importDefault(__webpack_require__(7078));
var void_tag_1 = __importDefault(__webpack_require__(4173));
var comment_1 = __importDefault(__webpack_require__(5059));
var node_1 = __importDefault(__webpack_require__(7016));
var text_1 = __importDefault(__webpack_require__(5155));
var type_1 = __importDefault(__webpack_require__(3152));
...
var _useScrollRestoration = __webpack_require__(9181);
...
var _assertThisInitialized2 = _interopRequireDefault(__webpack_require__(6417));
var _inheritsLoose2 = _interopRequireDefault(__webpack_require__(259));
var React = _interopRequireWildcard(__webpack_require__(7905));
var _propTypes = _interopRequireDefault(__webpack_require__(2688));
var _sessionStorage = __webpack_require__(1171);
...
"use strict";
module.exports = require("/Users/codecharmer/gramo/node_modules/react-dom/server.js");
...
var boolbase_1 = __importDefault(__webpack_require__(5740));
/**
...
/******/ 			return "" + ({"88":"component---src-templates-journal-post-tsx","265":"component---src-templates-page-tsx","289":"component---src-templates-location-tsx","446":"component---src-templates-journal-category-tsx","453":"component---src-pages-404-tsx","494":"component---src-templates-cart-tsx","508":"component---src-templates-order-confirmed-tsx","663":"component---src-templates-locations-index-tsx","708":"component---src-templates-coffee-tsx","741":"component---src-templates-menu-tsx","772":"component---src-templates-checkout-tsx","927":"component---src-templates-coffee-index-tsx"}[chunkId] || chunkId) + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
/* harmony export */ });
/* harmony import */ var react_server_dom_webpack_writer_node_server__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2270);
...
const React=__webpack_require__(7905);const path=__webpack_require__(2003);const{renderToStaticMarkup,renderToPipeableStream}=__webpack_require__(9701);const{ServerLocation,Router,isRedirect}=__webpack_require__(8192);const merge=__webpack_require__(4156);const{StaticQueryContext}=__webpack_require__(230);const fs=__webpack_require__(3759);const{WritableAsPromise}=__webpack_require__(9791);const{RouteAnnouncerProps}=__webpack_require__(4230);const{apiRunner,apiRunnerAsync}=__webpack_require__(5716);const asyncRequires=__webpack_require__(5593);const{version:gatsbyVersion}=__webpack_require__(6254);const{grabMatchParams}=__webpack_require__(9741);const{headHandlerForSSR}=__webpack_require__(3162);const{SlicesResultsContext,SlicesContext,SlicesMapContext,SlicesPropsContext}=__webpack_require__(2092);const{ServerSliceRenderer}=__webpack_require__(867);// we want to force posix-style joins, so Windows doesn't produce backslashes for urls
const{join}=path.posix;const testRequireError=(moduleName,err)=>{const regex=new RegExp(`Error: Cannot find module\\s.${moduleName}`);const firstLine=err.toString().split(`\n`)[0];return regex.test(firstLine);};let Html;try{Html=__webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../src/html'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));}catch(err){if(testRequireError(`../src/html`,err)){Html=__webpack_require__(6089);}else{throw err;}}Html=Html&&Html.__esModule?Html.default:Html;const getPageDataPath=path=>{const fixedPagePath=path===`/`?`index`:path;return join(`page-data`,fixedPagePath,`page-data.json`);};const createElement=React.createElement;const sanitizeComponents=components=>{const componentsArray=[].concat(components).flat(Infinity).filter(Boolean);return componentsArray.map(component=>{// Ensure manifest is always loaded from content server
