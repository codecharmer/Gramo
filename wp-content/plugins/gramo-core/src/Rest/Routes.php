...
use Gramo\Core\Ordering\PickupScheduler;
...
/**
 * Namespace `gramo/v1`. These routes expose only non-secret scheduling data
...
final class Routes implements Bootable {
			...
			array(
				...
				'args'                => array(
					'date' => array(
						'required'          => true,
						'type'              => 'string',
						'description'       => __( 'Fecha de recolección en formato YYYY-MM-DD.', 'gramo-core' ),
	...
	/**
	 * GET /gramo/v1/availability?date=YYYY-MM-DD
	 *
