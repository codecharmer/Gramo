 ...
 * Slug: gramo/hours-location
 * Categories: gramo-page
 * Description: Horario y dirección en ficha de datos, enlazados por el binding gramo/business, con mapa y botón de indicaciones.
...
<!-- wp:paragraph {"metadata":{"bindings":{"content":{"source":"gramo/business","args":{"key":"hours_summary"}}}},"className":"pf-facts__v"} -->
...
<!-- wp:paragraph {"metadata":{"bindings":{"content":{"source":"gramo/business","args":{"key":"hours_closed"}}}},"className":"pf-facts__v"} -->
...
<!-- wp:paragraph {"metadata":{"bindings":{"content":{"source":"gramo/business","args":{"key":"address"}}}},"className":"pf-facts__v"} -->
<p class="pf-facts__v">Calle Ejemplo 000, Cuernavaca, Morelos</p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph {"metadata":{"bindings":{"content":{"source":"gramo/business","args":{"key":"phone"}}}},"className":"pf-facts__v"} -->
<p class="pf-facts__v">+52 000 000 0000</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:buttons {"style":{"spacing":{"margin":{"top":"var:preset|spacing|lg"}}}} -->
<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--lg)"><!-- wp:button {"className":"is-style-ink","metadata":{"bindings":{"url":{"source":"gramo/business","args":{"key":"maps_url"}}}}} -->
<div class="wp-block-button is-style-ink"><a class="wp-block-button__link wp-element-button" href="#">Cómo llegar</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column -->
...
<figure class="wp-block-image size-large pf-figure pf-figure--wide"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/placeholder-mapa.svg" alt="Mapa de la ubicación de Gramo Panadería en Cuernavaca"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
